...
const categories = [
    {
        id: "all-shoes", // Added ID for navigation
        title: "Shoes",
    ...
    {
        id: "all-bags", // Added ID for navigation
        title: "Bags",
...
const subCategories = [
    ...
    {
        id: "sports-performance", // ID already exists
        title: "Sports Wear", // Renamed to match requirements
...
const Categories: React.FC = () => {
    return (
        <section id="categories" className="py-24 bg-primary-dark px-4 sm:px-8">
            <div className="max-w-[1920px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-8">
                    {categories.map((cat, index) => (
                        <div key={index} className="relative group h-[400px] md:h-[500px] overflow-hidden cursor-pointer rounded-2xl md:rounded-none">
                            <img
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-cream">
                                <span className="font-headline text-4xl md:text-6xl font-black tracking-tighter mb-4 uppercase">
                                    {cat.title}
                                </span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                    {subCategories.map((sub, index) => (
                        <div key={index} className="group cursor-pointer">
                            <div className="bg-sage-green/5 aspect-square mb-6 overflow-hidden relative border border-cream/5 rounded-xl md:rounded-none">
                                <img
                            ...
                            <h3 className="font-headline font-bold text-xs md:text-sm tracking-tight uppercase text-cream group-hover:text-sage-green transition-colors">
                                {sub.title}
                            </h3>
                            <p className="text-[9px] md:text-[10px] text-sage-green font-label mt-1 uppercase tracking-wider">
                                {sub.subtitle}
                            </p>
                        </div>
                    ))}
